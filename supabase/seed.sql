-- ============================================================
-- OptiTurno — Seed de datos de prueba
-- Ejecutado después de las migraciones en `supabase db reset`
-- ============================================================

-- 1. Usuarios de prueba
-- UUIDs fijos para que el frontend (modo pruebas) los referencie de forma estable
...
-- 5. Profesional de prueba (vinculado al usuario 11111111...)
