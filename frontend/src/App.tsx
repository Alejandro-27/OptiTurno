  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#020617] text-slate-800 dark:text-slate-100 flex flex-col font-sans selection:bg-indigo-500/30 selection:text-indigo-200 transition-colors duration-200">
      ...
      <header className="bg-white dark:bg-[#070b19] border-b border-slate-200 dark:border-indigo-500/10 px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4 sticky top-0 z-50 transition-colors duration-200">
        ...
        {/* View Mode Selectors */}
        <div className="flex bg-slate-100 dark:bg-slate-950 p-1 rounded-xl border border-slate-200 dark:border-slate-900/60 shadow-inner">
          <button
      ...
      <div className="flex-grow flex flex-col md:flex-row">
                  ...
                  <div className="mb-6 flex justify-between items-center flex-wrap gap-2 text-left">
                    <div>
                      <h2 className="text-xl md:text-2xl font-extrabold text-slate-900 dark:text-slate-50">
                        ...
                        {adminTab === "availability" &&
                          "Semanas Horarias Laborales"}
                        {adminTab === "profile" &&
                          "Perfil Onboarding del Comercio"}
                        {adminTab === "login" &&
                          "Visual de Acceso Administrativo"}
                      </h2>
          ...
          <main className="flex-1 p-6 lg:p-8 flex flex-col items-center justify-center bg-slate-100 dark:bg-[#030612] min-h-[calc(100vh-73px)] transition-colors duration-200">
            <div className="max-w-3xl text-center space-y-4 mb-4 select-none">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-slate-100">
                Simulador de PWA del Cliente
              </h2>
              <p className="text-xs text-slate-500 dark:text-slate-400 max-w-lg mx-auto">
                Los clientes acceden mediante el código QR de su comercio a esta
                experiencia ultraligera PWA, pudiendo agendar en segundos.
                Prueba el flujo interactivo abajo completando una reserva de
                prueba.
              </p>
            </div>
        ...
        {activeTab === "code" && (
          <main className="flex-1 p-6 lg:p-8 bg-slate-100 dark:bg-[#03050c] min-h-[calc(100vh-73px)] overflow-y-auto">
            {/* <AngularCodeViewer /> */}
          </main>
        )}
      </div>
